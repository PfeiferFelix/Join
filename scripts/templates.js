    ...
    return `<img class="sidebar__logo" src="assets/logos/logo.svg" alt="" />
                <nav class="sidebar__nav">
                    <ul class="sidebar__nav-list">
                        ...
                        <li class="sidebar__list-item">
                            <a class="sidebar__nav-link" href="board.html"><img class="sidebar__nav-img" src="assets/icons/sidebar/inactive/board.svg" alt="" /> <span id="js-sidebar-boards">Boards</span></a>
                        </li>
                        <li class="sidebar__list-item">
